...
| [IntegratedProfiles](https://github.com/obbywiki/mediawiki-extensions-IntegratedProfiles) | BETA \| Implements modern user profiles with the ability for other extensions to build on it. | v0.4.0 |
| [UserFlairs](https://github.com/obbywiki/mediawiki-extensions-UserFlairs) | Adds configurable flairs for user groups. | v0.2.0 |
